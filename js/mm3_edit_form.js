...
(function() {
  ...
  Mm3EditForm = (function() {
    function Mm3EditForm(entity_name, meta, callbacks, target, prefix, entity_id, parent_type, parent_id, reload_func, select_uplink_func, open_parent_func) {
    ...
    Mm3EditForm.prototype.clear = function() {
      this.target.empty();
      this.visible_data = {};
      this.objs = {};
      this.fld_meta = {};
    ...
    Mm3EditForm.prototype.build = function() {
      var req;
      this.clear();
    ...
    Mm3EditForm.prototype.build_form = function(is_edit) {
          ...
          return _.each(cells, function(cmeta) {
            ...
            if (!_.isEmpty(cmeta)) {
              ...
              if (_this["create_fld_" + kind]) {
                ...
                if (_this["Mm3_fld_" + kind]) {
                  _this.objs[cmeta.atr] = new _this["Mm3_fld_" + kind](td, fldn, cmeta.atr, cmeta, hpars.input, _this.visible_data[cmeta.atr], _this.callbacks);
    ...
    Mm3EditForm.prototype.save = function() {
      var d;
      d = {};
    ...
    Mm3EditForm.prototype.create_fld_text = function(td, pref, fldn, pars, value) {
      var fld;
    ...
    Mm3EditForm.prototype.create_fld_textarea = function(td, pref, fldn, pars, value) {
      var fld;
    ...
    Mm3EditForm.prototype.create_fld_date = function(td, pref, fldn, pars, value) {
      var fld;
    ...
    Mm3EditForm.prototype.create_fld_datetime = function(td, pref, fldn, pars, value) {
      var fld;
      fld = this.create_fld_text(td, pref, fldn, pars, value);
      fld.datetimepicker({
        lang: "ru",
    ...
    Mm3EditForm.prototype.create_fld_frozentext = function(td, pref, fldn, pars, value) {
      var fld;
      fld = this.create_fld_text(td, pref, fldn, pars, value);
    ...
    Mm3EditForm.prototype.create_fld_sel = function(td, pref, fldn, pars, value) {
      var fld;
      fld = $("<select id=\"" + pref + "\" />");
      this.set_pars(fld, pars);
    ...
    Mm3EditForm.prototype.create_fld_span = function(td, pref, fldn, pars, value) {
      var fld;
      if (value == null) {
        value = '';
      }
    ...
    Mm3EditForm.prototype.create_fld_link = function(td, pref, fldn, pars, value) {
    ...
    Mm3EditForm.prototype.create_fld_hidden = function(td, pref, fldn, pars, value) {
      var fld;
    ...
    Mm3EditForm.prototype.ac = function(msg) {
      return console.log("Mm3EditForm: " + msg);
    };

    Mm3EditForm.prototype.set_pars = function(target, hash_pars) {
    ...
    Mm3EditForm.prototype.alert = function(msg) {
      var clbk;
  ...
  Mm3.prototype.Mm3EditForm = Mm3EditForm;
