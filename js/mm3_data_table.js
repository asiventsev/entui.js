...
(function() {
  ...
  Mm3DataTable = (function() {
    function Mm3DataTable(entity_name, meta, callbacks, target, prefix, table_type, parent_type, parent_id, open_dialog_func, select_uplink_func, ret_fld_list) {
    ...
    Mm3DataTable.prototype.build = function() {
      this.clear();
      this.build_filters();
      this.buld_button();
    ...
    Mm3DataTable.prototype.clear = function() {
      this.target.empty();
    ...
    Mm3DataTable.prototype.build_filters = function() {
    ...
    Mm3DataTable.prototype.filter_change = function(atr, val) {
    ...
    Mm3DataTable.prototype.table_update = function() {
      if (this.table) {
    ...
    Mm3DataTable.prototype.clear_filters = function() {
    ...
    Mm3DataTable.prototype.buld_button = function() {
    ...
    Mm3DataTable.prototype.build_table = function() {
    ...
    Mm3DataTable.prototype.get_select_fld = function() {
    ...
    Mm3DataTable.prototype.uplink_make_row_selection = function(row_number, row) {
      var clear;
    ...
    Mm3DataTable.prototype.make_datatable = function(target, pars) {
      var default_pars;
      default_pars = {
        oLanguage: {
    ...
    Mm3DataTable.prototype.get_id_by_row = function(row_id) {
      var row_number;
    ...
    Mm3DataTable.prototype.ac = function(msg) {
      return console.log("Mm3DataTable: " + msg);
    };

    Mm3DataTable.prototype.wait = function(msg) {
      if (msg == null) {
    ...
    Mm3DataTable.prototype["continue"] = function() {
      if (this.wait_window) {
    ...
    Mm3DataTable.prototype.get_parent_prefix = function() {
      var l;
  ...
  Mm3.prototype.Mm3DataTable = Mm3DataTable;
